...
#     ABSTRACT_FROM => q[lib/Acme/MyFirstModule/NANDO.pm]
...
MAKE = dmake
FULLEXT = Acme\MyFirstModule\NANDO
BASEEXT = NANDO
...
TO_INST_PM = lib/Acme/MyFirstModule/NANDO.pm

PM_TO_BLIB = lib/Acme/MyFirstModule/NANDO.pm \
	blib\lib\Acme\MyFirstModule\NANDO.pm
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) "abstract: 'The great new Acme::MyFirstModule::NANDO!'" >> META_new.yml
	...
	$(NOECHO) $(ECHO) "   \"abstract\" : \"The great new Acme::MyFirstModule::NANDO^!\"," >> META_new.json
	...
	$(NOECHO) $(ECHO) "   }}," >> META_new.json
	$(NOECHO) $(ECHO) "   \"name\" : \"Acme-MyFirstModule-NANDO\"," >> META_new.json
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e "pm_to_blib({{@ARGV}}, '$(INST_LIB)\auto', q[$(PM_FILTER)], '$(PERM_DIR)')" -- \
	  lib/Acme/MyFirstModule/NANDO.pm blib\lib\Acme\MyFirstModule\NANDO.pm 
